...
exports.LimiterAlbumAPI = void 0;
const AlbumInfoParser_js_1 = __importDefault(require("./AlbumInfoParser.js"));
const BaseAPIWithImageSupport_js_1 = __importDefault(require("../common/BaseAPIWithImageSupport.js"));
class AlbumAPI extends BaseAPIWithImageSupport_js_1.default {
    async getInfo(params) {
        ...
        return AlbumInfoParser_js_1.default.parseInfo(html, opts);
    }
}
exports.default = AlbumAPI;
class LimiterAlbumAPI extends AlbumAPI {
    constructor(params) {
        super(params);
...
exports.LimiterAlbumAPI = LimiterAlbumAPI;
